!! Model extended from: Thijssen, J. J. (2022). Optimal investment and abandonment decisions for projects with construction uncertainty. European Journal of Operational Research, 298(1), 368–379. 

This repository contains a numerical solver for an optimal free-boundary problem, applied to the real options valuation of the Davy oil field to evaluate investment decisions and optimal restart triggers under uncertainty during asset decommissioning. 
...
Also attached is a formal write up detailing the model, parameters and findings.
